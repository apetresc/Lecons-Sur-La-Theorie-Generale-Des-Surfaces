...
\Verse{1} Considérons un corps solide ou système invariable, mobile autour d'un point fixe. On sait qu'à un instant 
...
\Verse{2} Tout cela étant rappelé, nous allons étudier la question suivante, qui est fondamentale dans notre théorie: 
...
\Verse{3} Nous allons maintenant étudier le cas où le système mobile n'a plus de point fixe. Alors il faut joindre 
...
\Verse{4} Pour indiquer dès à présent une application des propositions précédentes, considérons une courbe gauche 
...
\Verse{5} La méthode qui nous a permis de les établir met en évidence quelques propositions qu'il serait aisé de 
...
\Verse{6} Nous signalerons encore la théorème suivant qui est fort important:
\begin{thm}
...
\Verse{7} Dans le mouvement que nous venons d'étudier, trois des six quantités $\xi$, \ldots, $p$, \ldots sont 
...
\Verse{8} La méthode cinématique que nous venons d'exposer s'applique d'une manière élégante à la solution complète 
...
\Verse{9} Réciproquement, s'il existe une relation linéaire entre les deux courbures
\[
...
\Verse{10} Revenons au cas général et cherchons les deux courbures de la courbe lieu de $M'$. Le trièdre $(T')$ 
...
\Verse{11} Les résultats obtenus par M. Bertrand donnent immédiatement la solution d'une problème dont on s'est 
...
\Verse{12} Nous terminerons ce sujet en donnant la détermination des développées d'une courbe gauche.
